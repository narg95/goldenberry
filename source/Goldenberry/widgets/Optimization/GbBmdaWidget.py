...
class GbBmdaWidget(GbBaseEdaWidget):
    ...
    def setup_optimizer(self):
        self.optimizer.setup(self.var_size, self.cand_size, max_evals = self.max_evals, callback_func = self.progress, dependency_method = DependencyMethod.chi2_test if self.method == 0 else DependencyMethod.sim)